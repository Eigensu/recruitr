...
_MAPPINGS = [
    ...
    ("CLI-001-POS-001", _EMAIL_SNEHA, PipelineStage.selected),
    ("CLI-014-POS-004", "ananya.marketing@example.com", PipelineStage.selected),
    ("CLI-071-POS-001", "chef.rajesh@example.com", PipelineStage.selected),
