      ...
      <section className="relative flex flex-1 flex-col items-center justify-center overflow-hidden bg-white px-6 py-8 sm:px-12 lg:py-0">
        ...
        <div className="w-full max-w-sm">
          <div className="mb-8 text-center anim-up d3 lg:mb-10">
            ...
            <p className="text-sm text-muted">Join Binge Consulting and start building your team</p>
          </div>
          ...
          >
            ...
            <p className="text-center text-[11px] leading-relaxed text-muted anim-up d8">
          ...
          <p className="mt-7 text-center text-sm text-muted anim-in d10">
            ...
            <Link href="/sign-in" className="font-semibold text-navy hover:text-charcoal">
              Sign in
            </Link>
          </p>
        </div>
